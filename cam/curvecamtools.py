...
class CamCurveIntarsion(bpy.types.Operator):
    ...
    backlight: bpy.props.FloatProperty(
        name="Backlight seat",
        default=0.000,
        min=0,
        max=0.010,
    ...
    perimeter_cut: bpy.props.FloatProperty(
    ...
    intarsion_thickness: bpy.props.FloatProperty(
    ...
    backlight_depth_from_top: bpy.props.FloatProperty(
    ...
    def execute(self, context):
        ...
        diam = (
            self.diameter * 1.05 + self.backlight * 2
...
class CamCurveOvercuts(bpy.types.Operator):
    ...
    diameter: bpy.props.FloatProperty(
        name="diameter", default=0.003175, min=0, max=100, precision=4, unit="LENGTH"
    )
    threshold: bpy.props.FloatProperty(
        name="threshold",
        default=math.pi / 2 * 0.99,
        min=-3.14,
        max=3.14,
        precision=4,
        subtype="ANGLE",
...
class CamCurveOvercutsB(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for s in shapes.geoms:
            s = shapely.geometry.polygon.orient(
                s, 1
...
class CamMeshGetPockets(bpy.types.Operator):
    ...
    zlimit: bpy.props.FloatProperty(
        name="z limit",
...
class CamOffsetSilhouete(bpy.types.Operator):
    ...
    offset: bpy.props.FloatProperty(
        name="offset", default=0.003, min=-100, max=100, precision=4, unit="LENGTH"
    )
    mitrelimit: bpy.props.FloatProperty(
        name="Mitre Limit", default=0.003, min=0.0, max=20, precision=4, unit="LENGTH"
    )
    style: bpy.props.EnumProperty(
        name="type of curve",
