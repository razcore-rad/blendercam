...
class CamSineCurve(bpy.types.Operator):
    ...
    amplitude: bpy.props.FloatProperty(
        name="Amplitude", default=0.01, min=0, max=10, precision=4, unit="LENGTH"
    )
    period: bpy.props.FloatProperty(
        name="Period", default=0.5, min=0.001, max=100, precision=4, unit="LENGTH"
    )
    beatperiod: bpy.props.FloatProperty(
    ...
    shift: bpy.props.FloatProperty(
        name="phase shift", default=0, min=-360, max=360, precision=4, unit="ROTATION"
    )
    offset: bpy.props.FloatProperty(
        name="offset", default=0, min=-1.0, max=1, precision=4, unit="LENGTH"
    )
    iteration: bpy.props.IntProperty(name="iteration", default=100, min=50, max=2000)
    maxt: bpy.props.FloatProperty(
        name="Wave ends at x", default=0.5, min=-3.0, max=3, precision=4, unit="LENGTH"
    )
    mint: bpy.props.FloatProperty(
        name="Wave starts at x", default=0, min=-3.0, max=3, precision=4, unit="LENGTH"
    )
    wave_distance: bpy.props.FloatProperty(
    ...
    wave_angle_offset: bpy.props.FloatProperty(
    ...
    wave_amount: bpy.props.IntProperty(
        name="amount of multiple waves", default=1, min=1, max=2000
    )
    ...
    def execute(self, context):
        ...
        if self.wave == "sine":
            ...
            if self.beatperiod != 0:
                zstring += "+" + str(
                    triangle(80, self.period + self.beatperiod, self.amplitude)
                )
...
class CamLissajousCurve(bpy.types.Operator):
    ...
    amplitude_A: bpy.props.FloatProperty(
        name="Amplitude A", default=0.1, min=0, max=100, precision=4, unit="LENGTH"
    )
    waveA: bpy.props.EnumProperty(
        name="Wave X",
        items=(
            ("sine", "Sine Wave", "Sine Wave"),
            ("triangle", "Triangle Wave", "triangle wave"),
    ...
    amplitude_B: bpy.props.FloatProperty(
        name="Amplitude B", default=0.1, min=0, max=100, precision=4, unit="LENGTH"
    )
    waveB: bpy.props.EnumProperty(
        name="Wave Y",
        items=(
            ("sine", "Sine Wave", "Sine Wave"),
            ("triangle", "Triangle Wave", "triangle wave"),
    ...
    period_A: bpy.props.FloatProperty(
        name="Period A", default=1.1, min=0.001, max=100, precision=4, unit="LENGTH"
    )
    period_B: bpy.props.FloatProperty(
        name="Period B", default=1.0, min=0.001, max=100, precision=4, unit="LENGTH"
    )
    period_Z: bpy.props.FloatProperty(
        name="Period Z", default=1.0, min=0.001, max=100, precision=4, unit="LENGTH"
    )
    ...
    mint: bpy.props.FloatProperty(
        name="Wave starts at x", default=0, min=-10.0, max=3, precision=4, unit="LENGTH"
    )
...
class CamHypotrochoidCurve(bpy.types.Operator):
    ...
    typecurve: bpy.props.EnumProperty(
        name="type of curve",
        items=(
    ...
    dip: bpy.props.FloatProperty(
        name="variable depth from center", default=0.00, min=-100, max=100, precision=4
    )
...
class CamCustomCurve(bpy.types.Operator):
    ...
    xstring: bpy.props.StringProperty(
        name="X equation", description="Equation x=F(t)", default="t"
    )
    ystring: bpy.props.StringProperty(
        name="Y equation", description="Equation y=F(t)", default="0"
    )
    zstring: bpy.props.StringProperty(
        name="Z equation", description="Equation z=F(t)", default="0.05*sin(2*pi*4*t)"
    )

    iteration: bpy.props.IntProperty(name="iteration", default=100, min=50, max=2000)
    maxt: bpy.props.FloatProperty(
        name="Wave ends at x", default=0.5, min=-3.0, max=10, precision=4, unit="LENGTH"
    )
    mint: bpy.props.FloatProperty(
        name="Wave starts at x", default=0, min=-3.0, max=3, precision=4, unit="LENGTH"
    )
...
def ssine(A, T, dc_offset=0, phase_shift=0):
    return (
        str(round(dc_offset, 6))
        + "+"
        + str(round(A, 6))
        + "*sin((2*pi/"
        + str(round(T, 6))
        + ")*(t+"
        + str(round(phase_shift, 6))
        + "))"
    )
