...
from . import ui, ops, curvecamtools, curvecamequation, curvecamcreate, utils, simple, polygon_utils_cam  # , post_processors
...
def updateExact(o, context):
    ...
    o.update_zbufferimage_tag = True
    o.update_offsetimage_tag = True
    if o.use_exact and (o.strategy == 'POCKET' or o.strategy == 'MEDIAL_AXIS' or o.inverse):
        #    o.use_exact = False
...
def updateOpencamlib(o, context):
    ...
    o.changed = True
    if o.use_opencamlib and (o.strategy == 'POCKET' or o.strategy == 'MEDIAL_AXIS' or o.inverse):
        o.use_exact = False
        o.use_opencamlib = False
        print('pocket cannot use opencamlib')
