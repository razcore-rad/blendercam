...
from . import (curvecamcreate, curvecamequation, curvecamtools, ops, ui,
               ui_panels, utils)
...
class machineSettings(bpy.types.PropertyGroup):
    ...
    mtc_position: bpy.props.FloatVectorProperty(
        name="MTC position",
        default=(0, 0, 0),
        unit="LENGTH",
        precision=PRECISION,
    ...
    ending_position: bpy.props.FloatVectorProperty(
        name="End position",
        default=(0, 0, 0),
        unit="LENGTH",
        precision=PRECISION,
    ...
    working_area: bpy.props.FloatVectorProperty(
        name="Work Area",
    ...
    feedrate_min: bpy.props.FloatProperty(
    ...
    feedrate_max: bpy.props.FloatProperty(
    ...
    feedrate_default: bpy.props.FloatProperty(
    ...
    hourly_rate: bpy.props.FloatProperty(
        name="Price per hour", default=100, min=0.005, precision=2
    )

    # UNSUPPORTED:

    spindle_min: bpy.props.FloatProperty(
    ...
    spindle_max: bpy.props.FloatProperty(
    ...
    spindle_default: bpy.props.FloatProperty(
    ...
    spindle_start_time: bpy.props.FloatProperty(
    ...
    axis4: bpy.props.BoolProperty(
        name="#4th axis", description="Machine has 4th axis", default=0
    )
    axis5: bpy.props.BoolProperty(
        name="#5th axis", description="Machine has 5th axis", default=0
    )

    eval_splitting: bpy.props.BoolProperty(
        name="Split files",
        description="split gcode file with large number of operations",
        default=True,
    )  # split large files
    split_limit: bpy.props.IntProperty(
    ...
    collet_size: bpy.props.FloatProperty(
        name="#Collet size",
...
class PackObjectsSettings(bpy.types.PropertyGroup):
    ...
    sheet_fill_direction: bpy.props.EnumProperty(
        name="Fill direction",
        items=(
    ...
    sheet_x: bpy.props.FloatProperty(
        name="X size",
    ...
    sheet_y: bpy.props.FloatProperty(
        name="Y size",
        description="Sheet size",
        min=0.001,
        max=10,
...
class SliceObjectsSettings(bpy.types.PropertyGroup):
    ...
    slice_distance: bpy.props.FloatProperty(
    ...
    slice_3d: bpy.props.BoolProperty(
        name="3d slice", description="for 3d carving", default=False
    )
...
class camOperation(bpy.types.PropertyGroup):
    name: bpy.props.StringProperty(
        name="Operation Name", default="Operation", update=updateRest
    )
    filename: bpy.props.StringProperty(
        name="File name", default="Operation", update=updateRest
    )
    ...
    simplify_tol: bpy.props.IntProperty(
        name="Tolerance",
    ...
    curve_object1: bpy.props.StringProperty(
        name="Curve target",
    ...
    cutter_object_name: bpy.props.StringProperty(
        name="Cutter object",
        description="object used as custom cutter for this operation",
        update=updateZbufferImage,
    )

    machine_axes: bpy.props.EnumProperty(
        name="Number of axes",
        items=(
            ("3", "3 axis", "a"),
    ...
    strategy4axis: bpy.props.EnumProperty(
    ...
    strategy5axis: bpy.props.EnumProperty(
        name="Strategy",
        items=(
            (
                "INDEXED",
    ...
    rotary_axis_1: bpy.props.EnumProperty(
        name="Rotary axis",
        items=(
            ("X", "X", ""),
            ("Y", "Y", ""),
    ...
    rotary_axis_2: bpy.props.EnumProperty(
        name="Rotary axis 2",
        items=(
            ("X", "X", ""),
            ("Y", "Y", ""),
    ...
    array_y_count: bpy.props.IntProperty(
        name="Y count",
        description="Y count",
        default=1,
        min=1,
    ...
    array_x_distance: bpy.props.FloatProperty(
        name="X distance",
    ...
    array_y_distance: bpy.props.FloatProperty(
        name="Y distance",
        description="distance between operation origins",
        min=0.00001,
        max=1.0,
    ...
    # pocket options
    pocket_option: bpy.props.EnumProperty(
        name="Start Position",
        items=(
            ("INSIDE", "Inside", "a"),
            ("OUTSIDE", "Outside", "a"),
    ...
    pocketToCurve: bpy.props.BoolProperty(
    ...
    outlines_count: bpy.props.IntProperty(
        name="Outlines count`EXPERIMENTAL",
    ...
    straight: bpy.props.BoolProperty(
    ...
    # cutter
    cutter_id: bpy.props.IntProperty(
        name="Tool number",
    ...
    cutter_diameter: bpy.props.FloatProperty(
    ...
    cylcone_diameter: bpy.props.FloatProperty(
    ...
    cutter_length: bpy.props.FloatProperty(
        name="#Cutter length",
    ...
    cutter_flutes: bpy.props.IntProperty(
        name="Cutter flutes",
    ...
    cutter_tip_angle: bpy.props.FloatProperty(
    ...
    ball_radius: bpy.props.FloatProperty(
        name="Ball radius",
    ...
    bull_corner_radius: bpy.props.FloatProperty(
    ...
    cutter_description: bpy.props.StringProperty(
    ...
    Laser_delay: bpy.props.FloatProperty(
        name="Laser ON Delay",
    ...
    # steps
    dist_between_paths: bpy.props.FloatProperty(
    ...
    dist_along_paths: bpy.props.FloatProperty(
    ...
    old_rotation_A: bpy.props.FloatProperty(
        name="A axis angle",
    ...
    old_rotation_B: bpy.props.FloatProperty(
        name="A axis angle",
        description="old value of Rotate A axis\nto specified angle",
        default=0,
        min=-360,
    ...
    enable_A: bpy.props.BoolProperty(
        name="Enable A axis",
        description="Rotate A axis",
        default=False,
        update=updateRest,
    ...
    enable_B: bpy.props.BoolProperty(
        name="Enable B axis",
        description="Rotate B axis",
        default=False,
        update=updateRest,
    ...
    # carve only
    carve_depth: bpy.props.FloatProperty(
        name="Carve depth",
        default=0.001,
        min=-0.100,
        max=32,
    ...
    # drill only
    drill_type: bpy.props.EnumProperty(
        name="Holes on",
        items=(
    ...
    # waterline only
    slice_detail: bpy.props.FloatProperty(
    ...
    stepdown: bpy.props.FloatProperty(
        name="",
    ...
    first_down: bpy.props.BoolProperty(
        name="First down",
    ...
    ramp_out_angle: bpy.props.FloatProperty(
        name="Ramp out angle",
        default=math.pi / 6,
        min=0,
        max=math.pi * 0.4999,
    ...
    helix_enter: bpy.props.BoolProperty(
        name="Helix enter - EXPERIMENTAL",
        description="Enter material in helix",
        default=False,
        update=updateRest,
    )
    lead_in: bpy.props.FloatProperty(
        name="Lead in radius",
    ...
    lead_out: bpy.props.FloatProperty(
    ...
    profile_start: bpy.props.IntProperty(
        name="Start point",
    ...
    helix_diameter: bpy.props.FloatProperty(
        name="Helix diameter % of cutter D",
        default=90,
        min=10,
        max=100,
        precision=1,
    ...
    retract_height: bpy.props.FloatProperty(
    ...
    minz_from_ob: bpy.props.BoolProperty(
        name="Depth from object",
        description="Operation ending depth from object",
        default=True,
        update=updateRest,
    )
    minz_from_material: bpy.props.BoolProperty(
        name="Depth from material",
        description="Operation ending depth from material",
        default=False,
        update=updateRest,
    )
    minz: bpy.props.FloatProperty(
    ...
    start_type: bpy.props.EnumProperty(
        name="Start type",
        items=(
    ...
    source_image_crop: bpy.props.BoolProperty(
    ...
    source_image_crop_start_x: bpy.props.FloatProperty(
        name="crop start x",
        default=0,
        min=0,
        max=100,
    ...
    source_image_crop_start_y: bpy.props.FloatProperty(
        name="crop start y",
        default=0,
        min=0,
        max=100,
    ...
    source_image_crop_end_x: bpy.props.FloatProperty(
        name="crop end x",
        default=100,
        min=0,
        max=100,
    ...
    source_image_crop_end_y: bpy.props.FloatProperty(
        name="crop end y",
        default=100,
        min=0,
        max=100,
    ...
    protect_vertical: bpy.props.BoolProperty(
        name="Protect vertical",
        description="The path goes only vertically next to steep areas",
        default=True,
    )
    protect_vertical_limit: bpy.props.FloatProperty(
    ...
    ambient_behaviour: bpy.props.EnumProperty(
        name="Ambient",
    ...
    ambient_radius: bpy.props.FloatProperty(
        name="Ambient radius",
    ...
    use_limit_curve: bpy.props.BoolProperty(
    ...
    limit_curve: bpy.props.StringProperty(
        name="Limit curve",
    ...
    plunge_feedrate: bpy.props.FloatProperty(
        name="Plunge speed ",
    ...
    spindle_rpm: bpy.props.FloatProperty(
        name="Spindle rpm",
    ...
    spindle_rotation_direction: bpy.props.EnumProperty(
    ...
    movement_insideout: bpy.props.EnumProperty(
        name="Direction",
    ...
    parallel_step_back: bpy.props.BoolProperty(
    ...
    stay_low: bpy.props.BoolProperty(
        name="Stay low if possible", default=True, update=updateRest
    )
    ...
    do_simulation_feedrate: bpy.props.BoolProperty(
    ...
    dont_merge: bpy.props.BoolProperty(
    ...
    pencil_threshold: bpy.props.FloatProperty(
    ...
    crazy_threshold1: bpy.props.FloatProperty(
        name="min engagement",
        default=0.02,
        min=0.00000001,
        max=100,
    ...
    crazy_threshold5: bpy.props.FloatProperty(
    ...
    crazy_threshold2: bpy.props.FloatProperty(
        name="max engagement",
        default=0.5,
        min=0.00000001,
        max=100,
    ...
    crazy_threshold3: bpy.props.FloatProperty(
        name="max angle",
        default=2,
        min=0.00000001,
        max=100,
    ...
    crazy_threshold4: bpy.props.FloatProperty(
    ...
    add_pocket_for_medial: bpy.props.BoolProperty(
    ...
    add_mesh_for_medial: bpy.props.BoolProperty(
    ...
    ####
    medial_axis_threshold: bpy.props.FloatProperty(
    ...
    medial_axis_subdivision: bpy.props.FloatProperty(
    ...
    # chip_rate
    # bridges
    use_bridges: bpy.props.BoolProperty(
        name="Use bridges",
        description="use bridges in cutout",
        default=False,
        update=updateBridges,
    )
    bridges_width: bpy.props.FloatProperty(
    ...
    bridges_height: bpy.props.FloatProperty(
    ...
    bridges_collection_name: bpy.props.StringProperty(
        name="Bridges Collection",
        description="Collection of curves used as bridges",
        update=operationValid,
    )
    use_bridge_modifiers: bpy.props.BoolProperty(
    ...
    # material settings
    material_from_model: bpy.props.BoolProperty(
        name="Estimate from model",
        description="Estimate material size from model",
        default=True,
        update=updateMaterial,
    )
    material_radius_around_model: bpy.props.FloatProperty(
    ...
    material_center_x: bpy.props.BoolProperty(
        name="Center with X axis",
        description="Position model centered on X",
        default=False,
        update=updateMaterial,
    )
    material_center_y: bpy.props.BoolProperty(
        name="Center with Y axis",
        description="Position model centered on Y",
        default=False,
        update=updateMaterial,
    )

    material_Z: bpy.props.EnumProperty(
        name="Z placement",
        items=(
            ("ABOVE", "Above", "Place objec above 0"),
            ("BELOW", "Below", "Place object below 0"),
            ("CENTERED", "Centered", "Place object centered on 0"),
        ),
    ...
    material_origin: bpy.props.FloatVectorProperty(
    ...
    material_size: bpy.props.FloatVectorProperty(
        name="Material size",
    ...
    warnings: bpy.props.StringProperty(
        name="warnings", description="warnings", default="", update=updateRest
    )
    ...
    output_header: bpy.props.BoolProperty(
    ...
    enable_dust: bpy.props.BoolProperty(
        name="Dust collector",
        description="output user defined g-code command header at start of operation",
        default=False,
    )

    gcode_start_dust_cmd: bpy.props.StringProperty(
        name="Start dust collector",
        description="commands to start dust collection. Use ; for line breaks",
        default="M100",
    )

    gcode_stop_dust_cmd: bpy.props.StringProperty(
        name="Stop dust collector",
        description="command to stop dust collection. Use ; for line breaks",
        default="M101",
    )

    enable_hold: bpy.props.BoolProperty(
        name="Hold down",
        description="output hold down command at start of operation",
        default=False,
    )

    gcode_start_hold_cmd: bpy.props.StringProperty(
        name="g-code header",
        description="g-code commands at start of operation. Use ; for line breaks",
        default="M102",
    )

    gcode_stop_hold_cmd: bpy.props.StringProperty(
        name="g-code header",
        description="g-code commands at end operation. Use ; for line breaks",
        default="M103",
    )

    enable_mist: bpy.props.BoolProperty(
        name="Mist", description="Mist command at start of operation", default=False
    )

    gcode_start_mist_cmd: bpy.props.StringProperty(
        name="g-code header",
        description="g-code commands at start of operation. Use ; for line breaks",
        default="M104",
    )

    gcode_stop_mist_cmd: bpy.props.StringProperty(
        name="g-code header",
        description="g-code commands at end operation. Use ; for line breaks",
        default="M105",
    )

    output_trailer: bpy.props.BoolProperty(
        name="output g-code trailer",
        description="output user defined g-code command trailer at end of operation",
        default=False,
    )

    gcode_trailer: bpy.props.StringProperty(
        name="g-code trailer",
    ...
    borderwidth = 50
    object = None
    path_object_name: bpy.props.StringProperty(
        name="Path object", description="actual cnc path"
    )
    ...
    update_zbufferimage_tag: bpy.props.BoolProperty(
        name="mark zbuffer image for update",
        description="mark for update",
        default=True,
    )
    update_offsetimage_tag: bpy.props.BoolProperty(
        name="mark offset image for update", description="mark for update", default=True
    )
    update_silhouete_tag: bpy.props.BoolProperty(
        name="mark silhouete image for update",
        description="mark for update",
        default=True,
    )
    update_ambient_tag: bpy.props.BoolProperty(
        name="mark ambient polygon for update",
        description="mark for update",
        default=True,
    )
    update_bullet_collision_tag: bpy.props.BoolProperty(
    ...
    computing: bpy.props.BoolProperty(
        name="Computing right now", description="", default=False
    )
    pid: bpy.props.IntProperty(
        name="process id", description="Background process id", default=-1
    )
...
class camChain(
    ...
    active_operation: bpy.props.IntProperty(
        name="active operation", description="active operation in chain", default=-1
    )
    ...
    operations: bpy.props.CollectionProperty(
        type=opReference
...
class AddPresetCamOperation(bl_operators.presets.AddPresetBase, Operator):
    ...
    preset_values = [
        ...
        "o.material_size",
        "o.material_radius_around_model",
        "o.use_limit_curve",
        "o.cut_type",
        "o.use_exact",
        "o.exact_subdivide_edges",
        "o.minz_from_ob",
        "o.free_movement_height",
        "o.source_image_crop_start_x",
        "o.movement_insideout",
        "o.spindle_rotation_direction",
        "o.skin",
...
classes = [
    ...
    ui_panels.CAM_UL_operations,
    ui_panels.CAM_UL_chains,
    camOperation,
    opReference,
    camChain,
    machineSettings,
    ...
    ui_panels.CAM_MATERIAL_Panel,
    ui_panels.CAM_OPERATION_PROPERTIES_Panel,
    ui_panels.CAM_OPTIMISATION_Panel,
    ui_panels.CAM_AREA_Panel,
    ui_panels.CAM_MOVEMENT_Panel,
    ui_panels.CAM_FEEDRATE_Panel,
    ui_panels.CAM_CUTTER_Panel,
    ui_panels.CAM_MACHINE_Panel,
    ui.CAM_GCODE_Panel,
    ui.CAM_PACK_Panel,
    ui.CAM_SLICE_Panel,
...
def register():
    ...
    s.cam_active_operation = bpy.props.IntProperty(
    ...
    shutil.copytree(
        ...
        Path(bpy.utils.resource_path("USER")) / "scripts" / "presets",
        dirs_exist_ok=True,
    )
