...
from . import involute_gear, joinery, puzzle_joinery, simple, utils
...
class CamCurveHatch(bpy.types.Operator):
    ...
    distance: bpy.props.FloatProperty(
        name="spacing", default=0.015, min=0, max=3.0, precision=4, unit="LENGTH"
    )
    offset: bpy.props.FloatProperty(
        name="Margin", default=0.001, min=-1.0, max=3.0, precision=4, unit="LENGTH"
    )
    ...
    pocket_type: bpy.props.EnumProperty(
        name="Type pocket",
        items=(
...
class CamCurvePlate(bpy.types.Operator):
    ...
    radius: bpy.props.FloatProperty(
        name="Corner Radius", default=0.025, min=0, max=0.1, precision=4, unit="LENGTH"
    )
    ...
    hole_diameter: bpy.props.FloatProperty(
        name="Hole diameter", default=0.01, min=0, max=3.0, precision=4, unit="LENGTH"
    )
    hole_tolerance: bpy.props.FloatProperty(
    ...
    hole_vdist: bpy.props.FloatProperty(
    ...
    hole_hdist: bpy.props.FloatProperty(
    ...
    hole_hamount: bpy.props.IntProperty(
        name="Hole horiz amount", default=1, min=0, max=50
    )
    resolution: bpy.props.IntProperty(
        name="Spline resolution", default=50, min=3, max=150
    )
...
class CamCurveFlatCone(bpy.types.Operator):
    ...
    small_d: bpy.props.FloatProperty(
        name="small diameter", default=0.025, min=0, max=0.1, precision=4, unit="LENGTH"
    )
    ...
    height: bpy.props.FloatProperty(
        name="Height of cone", default=0.457, min=0, max=3.0, precision=4, unit="LENGTH"
    )
    tab: bpy.props.FloatProperty(
        name="tab witdh", default=0.01, min=0, max=0.100, precision=4, unit="LENGTH"
    )
    intake: bpy.props.FloatProperty(
        name="intake diameter", default=0, min=0, max=0.200, precision=4, unit="LENGTH"
    )
    ...
    def execute(self, context):
        ...
        bpy.ops.curve.simple(
            ...
            Simple_a=ab,
            Simple_b=a,
            Simple_endangle=math.degrees(angle),
            use_cyclic_u=True,
            edit_mode=False,
        )
...
class CamCurveMortise(bpy.types.Operator):
    ...
    finger_size: bpy.props.FloatProperty(
    ...
    min_finger_size: bpy.props.FloatProperty(
    ...
    finger_tolerance: bpy.props.FloatProperty(
    ...
    double_adaptive: bpy.props.BoolProperty(
        name="Double adaptive Pockets", default=False
    )
...
class CamCurveInterlock(bpy.types.Operator):
    ...
    plate_thickness: bpy.props.FloatProperty(
        name="Plate thickness", default=0.00477, min=0.001, max=3.0, unit="LENGTH"
    )
    opencurve: bpy.props.BoolProperty(name="OpenCurve", default=False)
    interlock_type: bpy.props.EnumProperty(
    ...
    finger_amount: bpy.props.IntProperty(
        name="Finger Amount", default=2, min=1, max=100
    )
    tangent_angle: bpy.props.FloatProperty(
    ...
    fixed_angle: bpy.props.FloatProperty(
        name="fixed angle",
        default=0.0,
        min=0.000,
        max=2,
...
class CamCurveDrawer(bpy.types.Operator):
    ...
    depth: bpy.props.FloatProperty(
        name="Drawer Depth", default=0.2, min=0, max=1.0, precision=4, unit="LENGTH"
    )
    width: bpy.props.FloatProperty(
    ...
    finger_inset: bpy.props.FloatProperty(
        name="Finger inset", default=0.0, min=0.0, max=0.01, precision=4, unit="LENGTH"
    )
    drawer_plate_thickness: bpy.props.FloatProperty(
        name="Drawer plate thickness",
        default=0.00477,
        min=0.001,
        max=3.0,
    ...
    drawer_hole_diameter: bpy.props.FloatProperty(
    ...
    drawer_hole_offset: bpy.props.FloatProperty(
    ...
    overcut_diameter: bpy.props.FloatProperty(
...
class CamCurvePuzzle(bpy.types.Operator):
    ...
    finger_amount: bpy.props.IntProperty(
        name="Finger Amount", default=1, min=0, max=100
    )
    stem_size: bpy.props.IntProperty(name="size of the stem", default=2, min=1, max=200)
    width: bpy.props.FloatProperty(
        name="Width", default=0.100, min=0.005, max=3.0, precision=4, unit="LENGTH"
    )
    height: bpy.props.FloatProperty(
    ...
    angleb: bpy.props.FloatProperty(
        name="angle B",
        default=math.pi / 4,
        min=-10,
        max=10,
    ...
    radius: bpy.props.FloatProperty(
        name="Arc Radius", default=0.025, min=0.005, max=5, precision=4, unit="LENGTH"
    )
    ...
    base_gender: bpy.props.EnumProperty(
        name="Base gender",
        items=(
    ...
    multiangle_gender: bpy.props.EnumProperty(
    ...
    twist_thick: bpy.props.FloatProperty(
    ...
    twist_line_amount: bpy.props.IntProperty(
        name="amount of separators", default=2, min=1, max=600
    )
    ...
    twist_separator_spacing: bpy.props.FloatProperty(
    ...
    twist_separator_edge_distance: bpy.props.FloatProperty(
    ...
    tile_x_amount: bpy.props.IntProperty(
        name="amount of x fingers", default=2, min=1, max=600
    )
    tile_y_amount: bpy.props.IntProperty(
        name="amount of y fingers", default=2, min=1, max=600
    )
...
class CamCurveGear(bpy.types.Operator):
    ...
    tooth_spacing: bpy.props.FloatProperty(
    ...
    rim_size: bpy.props.FloatProperty(
        name="Rim size", default=0.003175, min=0, max=3.0, precision=4, unit="LENGTH"
    )
    hub_diameter: bpy.props.FloatProperty(
        name="Hub diameter", default=0.005, min=0, max=3.0, precision=4, unit="LENGTH"
    )
    ...
    clearance: bpy.props.FloatProperty(
        name="Clearance", default=0.00, min=0, max=0.1, precision=4, unit="LENGTH"
    )
    backlash: bpy.props.FloatProperty(
        name="Backlash", default=0.0, min=0.0, max=0.1, precision=4, unit="LENGTH"
    )
    rack_height: bpy.props.FloatProperty(
        name="Rack Height", default=0.012, min=0.001, max=1, precision=4, unit="LENGTH"
    )
    rack_tooth_per_hole: bpy.props.IntProperty(
        name="teeth per mounting hole", default=7, min=2
    )
