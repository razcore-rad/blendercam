...
cam_job.machine.post_processor_enum = "MACH3"
...
cam_job.machine.spindle_rpm.default = 20000
cam_job.machine.spindle_rpm.min = 5000
cam_job.machine.spindle_rpm.max = 25000
