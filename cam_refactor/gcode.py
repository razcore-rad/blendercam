...
class G:
    def __init__(
        ...
        *,
        ...
        self.feed_rate = 0.0
        self.vertical_feed_rate_factor = clamp(vertical_feed_rate_factor, 0.0, 1.0)
        self.set_abs()
    ...
    def abs_move(self, /, **kwargs) -> Self:
        ...
        is_rapid = kwargs.get(
            "z", self.position["z"]
        ) > self.rapid_height and not self.is_vertical_move(next_position)
