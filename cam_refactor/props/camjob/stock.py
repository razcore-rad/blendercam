...
class Stock(bpy.types.PropertyGroup):
    ...
    type: bpy.props.EnumProperty(name="Type", items=[("ESTIMATE", "Estimate from Job", ""), ("CUSTOM", "Custom", "")])
    ...
    custom_size: bpy.props.FloatVectorProperty(name="Size", min=1e-3, default=(5e-1, 5e-1, 1e-1), subtype="XYZ_LENGTH")
